...
class TopThree extends Component {
    ...
    render() {
        return (
            <div>
                <div id="TopThree" ref='TopThree' style={{ width:340, height: 200 }}></div>
            </div>
        );
    }
    ...
    componentDidMount() {
        let that = this;
        this.mycharts1 = echarts.init(document.getElementById("TopThree"));
        this.option = {
            color: ['#3398DB'],
            title: {
                x:'center',
    ...
    resizeContainer(){
        ...
        $("#TopThree").width (top_left_width);
        $("#TopThree").height (top_left_height);
    }
    handlebtnClick(e) {
